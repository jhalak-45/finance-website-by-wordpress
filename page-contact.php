...
<div class="container-fluid mt-5 contact-page p-2">
    ...
    <div class="container-contact row px-auto">
        <div class="col-md-6 information-container p-3">
            ...
            <div class="link-icons">
                ...
                <div class="links p-2">
                    <a href="<?php the_field('social_link_facebook', 12) ?>" class="link"><i class='bx bxl-facebook-circle facebook'></i></a>
                    <a href="<?php the_field('social_link_twitter', 12) ?>" class="link"><i class='bx bxl-twitter twitter'></i></a>
                    <a href="<?php the_field('social_link_linkedin', 12) ?>" class="link"><i class='bx bxl-linkedin linkedin'></i></a>
        ...
        <div class="col-md-6 contactform-container p-2 mt-1">
            <?php the_content(); ?>
        </div>
    </div>
    ...
    <div class="map-location">
        ...
        <iframe src="<?php the_field('map_location', 12) ?>" width="100%" height="450" style="border:1;" allowfullscreen="true" loading="fast" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
