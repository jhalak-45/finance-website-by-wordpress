...
<div class="container-fluid container-about">
    ...
    <div class="introduction mt-2">
        ...
        <h4 class="h4 text-danger ">Introduction</h4>
        <div class="row p-2">
            <div class="col-md-6">
                <img src="<?php the_field('image_of_organization', 16) ?>" alt="our image" height="100%" width="100%">

            </div>
            <div class="col-md-6">
                <p class="text-justify">
                    <?php the_field('introduction_text', 16) ?>
                </p>
            </div>
        </div>

        <div class="mission row p-2 justify-content-center ">
            <div class="col-md-6 container-mission m-1">
                <h5 class="h5 ">
                    Our Mission
                </h5>
                <p class="text">
                    <?php the_field('our_mission', 16) ?>
                </p>
            </div>
            <div class="col-md-5 container-vision m-1">
                <h5 class="h5 ">
                    Our Vision
                </h5>
                <p class="text">
                    <?php the_field('our_vision', 16) ?>
                </p>
        ...
        <div class="our-workingarea">
            ...
            <?php the_field('our_working_area', 16) ?>
